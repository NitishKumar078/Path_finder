...
//     var span_Text = document.getElementById("seconds").innerText;
//     // alert (span_Text);
...
function store_time(){
    ...
    httpr.open("post","index.php",true);
    httpr.setRequestHeader("content-type","application/x-www-form-urlencoded");
    httpr.onreadystatechange=function()
    {
      if(httpr.readyState==4 && httpr.status==200){
          document.getElementById("seconds").innerHTML=httpr.responseText;

      }  
    }
    httpr.send("seconds"+seconds);
}
